...
export const plateOffers: PlateOffer[] = [
  {
    ...
    cta: {
      label: "Ordina ora",
      href: whatsappHref("Ciao Kontap, vorrei ordinare 1 targa recensioni Google (34,99 €)."),
      external: true,
    },
  },
  {
    ...
    perks: [
      ...
      "+19,99 € l'una, fino a 10 targhe",
    ],
    cta: {
      label: "Ordina ora",
      href: whatsappHref("Ciao Kontap, vorrei ordinare 3 targhe recensioni Google (64,99 €)."),
      external: true,
    },
  },
  {
